...
import meraki from '../images/cisco_meraki.png'

const showcaseData = [
  {
    title: "Cisco Meraki",
    image: meraki,
    description: "Added new API features such as deletion of top level organizations, response code logging for api requests, and filtering api requests by specified parameters (Ruby | Ruby on Rails). Currently working on major back-end performance bottlenecks in critical sections of cloud architecture.",
